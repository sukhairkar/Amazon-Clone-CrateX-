...
"[project]/app/api/generate-description/route.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        const response = await fetch('https://openrouter.ai/api/v1/chat/completions', {
            method: 'POST',
            headers: {
                'Authorization': `Bearer ${__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.OPENROUTER_API_KEY}`,
            ...
            body: JSON.stringify({
                ...
                messages: [
                    {
                        role: 'system',
                        content: 'You are an e-commerce copywriter.'
                    },
                    {
                        role: 'user',
                        content: `Write a short, vivid product description (max 50 words) for: ${name}`
                    }
                ]
            })
        });
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$generate$2d$description$2f$route$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/api/generate-description/route.js [app-client] (ecmascript)");
;
...
function App() {
    ...
    const autoGenerate = async ()=>{
        ...
        try {
            ...
            if (res.ok && description) setValue('description', description);
            else {
...
//# sourceMappingURL=_9462ebcf._.js.map