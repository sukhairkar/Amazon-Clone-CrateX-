...
"[project]/lib/gemini.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/app/api/generateDescription/route.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gemini$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/gemini.js [app-client] (ecmascript)");
;
;
async function POST(req) {
    ...
    try {
        const description = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gemini$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateProductDescription"])(name);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NextResponse"].json({
            description
        });
    } catch (err) {
...
// import { POST } from '../api/generate-description/route'
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$generateDescription$2f$route$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/api/generateDescription/route.js [app-client] (ecmascript)");
;
...
function App() {
    _s();
    const [prod, setProd] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    ...
    const onSubmit = async (data)=>{
        ...
        formData1.append("img", data.img);
        formData1.append("price", data.price);
    };
    const generateDescription = async ()=>{
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$create$2f$data$3a$6d6369__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["createProduct"])(formData); // writes to Prisma on the server
...
_s(App, "gaxGDnZcqObNlqMJRm2QJdSxwHk=", false, function() {
    return [
...
//# sourceMappingURL=_bb90cdd6._.js.map